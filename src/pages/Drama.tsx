...
const dramaItems: DramaItem[] = [
  ...
  },
  {
    ...
    type: "Movie / 2021",
    category: "superheroMovies",
    wikiTitle: "Zack Snyder's Justice League",
    note: "如果真的有多元宇宙，我好希望可以把查導的DCEU看完，這部4小時補完真的太絕了。",
    rotate: "rotate-2",
  ...
  },
  {
    ...
    type: "Movie / 2017",
    category: "superheroMovies",
    wikiTitle: "Wonder Woman (2017 film)",
    note: "有些人說他不算在DCEU查導三部曲的佳作中，但其實我覺得還不賴，至少蓋爾加朵在這裡算演得還不錯。",
    rotate: "-rotate-3",
    offset: "md:translate-y-10",
    delay: "560ms",
  },
  ...
  },
  {
    ...
    note: "6000萬美金拍出來的超屌R級超英，只能說Ryan對死侍這角色是真愛了。",
    rotate: "-rotate-1",
  ...
  },
  {
    ...
    type: "Movie / 2016",
    category: "superheroMovies",
    wikiTitle: "Batman v Superman: Dawn of Justice",
    note: "評價兩極但現今回頭看真的也是神作，至少在華納的各種壓榨下故事講得很完整，查導風格依舊穩健。",
    rotate: "rotate-1",
    offset: "md:-translate-y-4",
    delay: "800ms",
  },
  ...
  },
  {
    ...
    type: "Movie / 2013",
    category: "superheroMovies",
    wikiTitle: "Man of Steel (film)",
    note: "查克史奈德的超人，與過往不同的黑暗敘事風格，在今日來看，是神作!!",
    rotate: "-rotate-2",
    offset: "md:translate-y-6",
    delay: "1040ms",
  },
  ...
  },
  {
    ...
    type: "Movie / 2009",
    category: "superheroMovies",
    wikiTitle: "Watchmen (film)",
    imageUrl: `${import.meta.env.BASE_URL}drama/watchmen.jpg`,
    note: "不是傳統爽片型超英，而是把英雄、權力、人性與世界局勢全部攪在一起的黑暗神作。",
    rotate: "-rotate-1",
    offset: "md:translate-y-8",
    delay: "1200ms",
  },
  ...
  },
  {
    ...
    type: "Movie / 2018",
    category: "blockbusterMovies",
    wikiTitle: "Ready Player One (film)",
    note: "遊戲、電影、流行文化彩蛋大集合，史匹柏把宅文化拍成大型遊樂園，娛樂性超高。",
    rotate: "rotate-1",
    offset: "md:-translate-y-3",
    delay: "80ms",
  },
  ...
  },
  {
    ...
    type: "Movie / 2015",
    category: "blockbusterMovies",
    wikiTitle: "Jurassic World",
    note: "恐龍樂園重啟，雖然劇情不是最神，但大銀幕爽度、懷舊感跟娛樂性都很足。",
    rotate: "-rotate-2",
    offset: "md:translate-y-6",
    delay: "240ms",
  },
  {
    ...
    type: "Movie / 2015",
    category: "blockbusterMovies",
    wikiTitle: "The Man from U.N.C.L.E. (film)",
    note: "冷戰特務、復古美術、時髦穿搭與輕鬆節奏，整部片很帥也很舒服。",
    rotate: "rotate-1",
    offset: "md:-translate-y-3",
    delay: "320ms",
  },
  ...
  },
  {
    ...
    type: "Movie / 2014",
    category: "blockbusterMovies",
    wikiTitle: "Kingsman: The Secret Service",
    note: "紳士西裝、特務訓練、誇張動作場面跟英式幽默混在一起，爽度跟風格都很鮮明。",
    rotate: "-rotate-2",
    offset: "md:translate-y-6",
    delay: "480ms",
  },
  ...
  },
  {
    ...
    type: "Movie / 1990",
    category: "blockbusterMovies",
    wikiTitle: "Back to the Future Part III",
    note: "時空冒險收尾篇，西部片元素加上博士與Marty的友情，三部曲收得很完整。",
    rotate: "-rotate-2",
    offset: "md:translate-y-6",
    delay: "800ms",
  },
  {
    ...
    type: "Movie / 1985",
    category: "blockbusterMovies",
    wikiTitle: "Back to the Future",
    note: "時間旅行電影的經典代表，而且在那個年代又很反套路，神作。",
    rotate: "-rotate-3",
    offset: "md:translate-y-10",
    delay: "960ms",
  },

  {
    ...
    note: "黑白成行的公路片，刻劃、立意都很發人深省，很好的詮釋種族議題的佳作。",
    rotate: "rotate-1",
    offset: "md:translate-y-12",
    delay: "0ms",
  },
  {
    ...
    note: "友情、夢想、家庭，充分詮釋那種青春期特有的叛逆與對生活的彆扭感。",
    rotate: "-rotate-2",
    offset: "md:translate-y-4",
    delay: "80ms",
  },
  ...
  },
  {
    ...
    type: "Movie / 2015",
    category: "lifeMovies",
    wikiTitle: "The Intern (2015 film)",
    note: "溫暖的職場小品，人生第二春、世代差異與人際關係都拍得很舒服，勞勃狄尼洛老戲骨真的強。",
    rotate: "rotate-1",
    offset: "md:translate-y-5",
    delay: "320ms",
  },
  {
    ...
    note: "真人真事改編，從墊底到逆轉人生。推當年超可愛的有村架純。",
    rotate: "-rotate-1",
    offset: "md:-translate-y-4",
    delay: "320ms",
  },
  ...
  },
  {
    ...
    type: "Movie / 2014",
    category: "lifeMovies",
    wikiTitle: "Chef (2014 film)",
    note: "失意主廚重新找回熱情、親情與生活節奏，看完會餓，也會覺得人生還是可以重新開始。",
    rotate: "-rotate-2",
    offset: "md:-translate-y-4",
    delay: "480ms",
  },
  {
    ...
    note: "有時候真正的冒險不是幻想，而是踏出去的那一步，做就對了。冰島真的好漂亮~ !",
    rotate: "rotate-2",
    offset: "md:translate-y-7",
    delay: "480ms",
  },
  {
    ...
    type: "Movie / 2013",
    category: "lifeMovies",
    wikiTitle: "About Time (2013 film)",
    imageUrl: `${import.meta.env.BASE_URL}drama/abouttime.png`,
    note: "現實人生無法重來，但我們依然能選擇過好每一天，感受每一天渺小但幸福的美好。",
    rotate: "-rotate-1",
    offset: "md:-translate-y-4",
    delay: "560ms",
  },
  {
    ...
    type: "Movie / 2013",
    category: "lifeMovies",
    wikiTitle: "Begin Again (film)",
    note: "音樂、失意、重新開始與城市感交織在一起，輕盈但很有療癒感的佳作，而且貢獻了Lost Star神曲。",
    rotate: "-rotate-1",
    offset: "md:-translate-y-4",
    delay: "560ms",
  },
  ...
  },
  {
    ...
    type: "Movie / 2009",
    category: "lifeMovies",
    wikiTitle: "The Blind Side (film)",
    note: "關於家庭、善意、機會與改變人生的故事，也是少數把種族問題講好的佳作。",
    rotate: "-rotate-2",
    offset: "md:translate-y-5",
    delay: "720ms",
  },
  {
    ...
    category: "lifeMovies",
    wikiTitle: "3 Idiots",
    note: "All is well. 主推一個突破陳舊教育體制，學習、人生與追求夢想的神作。",
    rotate: "rotate-1",
  ...
  },
  {
    ...
    type: "Movie / 2006",
    category: "lifeMovies",
    wikiTitle: "The Devil Wears Prada (film)",
    note: "職場的現實與殘酷跟人生自我追求的終極選擇題，你想要怎樣的人生? 當年的安好可愛~ !",
    rotate: "rotate-2",
    offset: "md:-translate-y-3",
    delay: "960ms",
  },
  {
    ...
    type: "Movie / 2004",
    category: "lifeMovies",
    wikiTitle: "The Terminal",
    note: "一個人被困在機場，卻活出善良、等待與生活感，湯姆漢克斯把小人物演得很溫柔。",
    rotate: "rotate-2",
    offset: "md:-translate-y-3",
    delay: "1040ms",
  },
  {
    ...
    note: "天才、疾病、陪伴與人生，沉穩但很有力量。當年珍妮佛康娜莉簡直美炸，現在也很美就是了...",
    rotate: "-rotate-1",
    offset: "md:-translate-y-5",
    delay: "1040ms",
  },
  {
    ...
    category: "lifeMovies",
    wikiTitle: "Cast Away",
    note: "一個人在孤島上面對生存、孤獨，與重返後勇敢面對現實的人生態度，Wilson掉到海裡真的淚崩...。",
    rotate: "rotate-1",
    offset: "md:-translate-y-4",
    delay: "1200ms",
  },
  {
    ...
    type: "Movie / 1998",
    category: "lifeMovies",
    wikiTitle: "The Truman Show",
    note: "金凱瑞最經典的代表作之一，用荒謬設定講自由意志、人生選擇與真實世界，越長大看越神。",
    rotate: "rotate-1",
    offset: "md:translate-y-4",
    delay: "1120ms",
  },
  ...
  },
  {
    ...
    note: "即使身在絕境中，絕對不可以放棄希望。因為 Hope is a good thing.",
    rotate: "rotate-3",
    offset: "md:translate-y-10",
    delay: "1200ms",
  },
  {
    ...
    type: "Movie / 1994",
    category: "lifeMovies",
    wikiTitle: "Forrest Gump",
    note: "人生就像一盒巧克力，純粹、善良、命運與時代交織在一起，經典到不能不放。",
    rotate: "rotate-2",
    offset: "md:-translate-y-2",
    delay: "1360ms",
  },
  {
    ...
    type: "Movie / 1993",
    category: "lifeMovies",
    wikiTitle: "Groundhog Day (film)",
    note: "時間循環神作，唯有好好生活、好好待人，才能活出有意義及有價值的人生。",
    rotate: "-rotate-1",
    offset: "md:-translate-y-4",
    delay: "1280ms",
  },
...
const categorySections: {
  ...
  },
  {
    ...
    title: "經典超英電影",
    description:
      "好的超英不斷銳減，爛的超英與日俱增，偶爾緬懷過去，還是不賴~",
  },
  {
    key: "blockbusterMovies",
    part: "movies",
    label: "Action Blockbusters",
    title: "爆米花科幻動作片",
    description:
      "現今好的爆米花科幻動作片，要講好一個故事也不多見...下面是真正的爆米花好片 !",
  },
  {
    key: "lifeMovies",
    part: "movies",
